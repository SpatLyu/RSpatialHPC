...
# mamba install -c https://mirrors.sustech.edu.cn/anaconda/cloud/conda-forge r-tmap r-magick -y
...
# Rscript - e "install.packages('spEDM_1.13.tar.gz', repos = NULL, type = 'source')"
